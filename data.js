...
exports.data = [
    {
        ...
        product_information: "Declaration of Importer: Direct import by the individual customer. Marketed by: Nike Global Trading B.V. Singapore Branch, 30 Pasir Panjang Road, #10-31/32, Mapletree Business City, Singapore 117 440"
    },
    {
        id: 2,
        ...
        overview: "Inspired by the game shoe worn by Mike throughout the '92 season, the latest iteration of the AJ7 revives its championship legacy for a new generation of sneakerheads. Come for the throwback style, stay all day for the premium construction and signature Air cushioning.",
        benefits: [
            {
                id: 1,
    ...
    },
    {
        ...
        overview: "Get that Jordan energy on your feet this festive season. Rich grain leather with bright details make this pair shine like festive lights.",
        benefits: [
            {
                id: 1,
    ...
    },
    {
        ...
        overview: "Inspired by generations of Js, these kicks are a collage of cool. Design details recall decades of legendary shoes while paying homage to MJs storied career. Breathable mesh, sturdy leather and lightweight Air cushioning in the heel make it that much easier to walk in the footsteps of greatness.",
        benefits: [
            {
                id: 1,
                text: "Nike Air technology absorbs impact for cushioning with every step."
